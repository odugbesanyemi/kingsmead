        ...
        <div class="page-content">
            <div class="bg-blue-50  py-20 md:py-32">
                <div class="max-w-7xl mx-auto max-md:p-5 sm:px-10">
                    <h1 class="text-5xl font-bold text-blue-700 mb-10">Board of Governors</h1>
    ...
    data() {
        return {
            ...
            governors:[
                ...
                {
                    img:defaultPic,
                    name:"Barr. Oyetan Janet",
                    position:"Member",
                },                {
                    img:defaultPic,
                    name:"Dr. Akintola Taofeek",
                    position:"Member",
                },                {
                    img:defaultPic,
                    name:"Mrs Faseru Ronke",
                    position:"Member",
                },{
                    img:defaultPic,
                    name:"Dr. Nwama Emmanuel",
                    position:"Member",
                },
