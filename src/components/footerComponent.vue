...
<template>
    <footer class="bg-white">
        <div class="max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
            ...
            <p class="mt-8 text-center text-base text-gray-400">&copy; 2022 Kingsmead Schools. All rights reserved.</p>
        </div>
    </footer>
</template>
        ...
        return {
            navigation: {
                ...
                social: [
                    {
                        name: 'Facebook',
                        href: 'https://mobile.facebook.com/profile.php?id=100064179545361&_rdc=1&_rdr',
